...
const HowItWorks = () => {
  ...
  useEffect(() => {
    ...
    const calculateLineHeight = () => {
      ...
      const iconCenterY = lastStepIconRect.top - lineContainerRect.top + (lastStepIconRect.height / 2);
    ...
    >
      <div className="flex max-w-5xl self-stretch items-start justify-center gap-20 px-6 py-28">
        ...
        <div className="relative flex flex-1 flex-col items-start">
          ...
          <ul ref={stepsListRef} className="flex flex-col items-start self-stretch">
