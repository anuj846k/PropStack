      ...
      <div className="w-[400px] border-r border-gray-200/80 flex flex-col bg-white">
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-start justify-between mb-4">
            ...
            <Button size="sm" className="h-8 gap-1.5 text-xs select-none rounded-xl">
              Trigger Call <Phone size={14} />
            </Button>
          </div>

          <div className="bg-purple-50/80 border border-purple-200/50 rounded-xl p-3 flex items-center gap-3 mb-4">
            ...
            <span className="text-xs font-semibold text-purple-700 px-2 py-1 bg-purple-100 rounded-lg cursor-pointer hover:bg-purple-200 transition-colors">
              Listen
            </span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              { l: "Promises", v: "1", c: "text-emerald-600" },
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-9 font-semibold text-gray-600 rounded-xl"
                  >
                    Schedule Follow-up
                  </Button>
                  <Button size="sm" className="h-9 font-semibold gap-1.5 rounded-xl">
